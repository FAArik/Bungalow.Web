...
namespace BungalowApi.Infrastructure.Migrations
{
    ...
    [Migration("20240304165125_bookingmissingcols")]
    partial class bookingmissingcols
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BungalowApi.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BungalowApi.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BungalowApi.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("BungalowApi.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BungalowApi.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
